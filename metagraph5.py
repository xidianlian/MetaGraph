# -*- coding: utf-8 -*-
"""
Created on Wed Mar 20 15:10:24 2019
...
train_kernel_path = OUTPUT_PATH + "\\meta5"
test_kernel_path = OUTPUT_PATH + "\\meta5.test"

train_label_path = OUTPUT_PATH + "\\y_train"
test_label_path = OUTPUT_PATH + "\\y_test"

def get_data():
    app_api = pd.read_csv(app_api_path ,dtype=np.int16) # shape(20807, 400)
    app_perm = pd.read_csv(app_perm_path ,dtype=np.int16)# shape(20807, 304)
...
def get_train_kernel(train_data, api_method, api_pack):
    ...
    app_app = app_api_api_app * app_perm_app
...
def get_test_kernel(train_data, test_data, api_method, api_pack):
    ...
    app_app = app_api_api_app * app_perm_app # shape(4162, 16645)
